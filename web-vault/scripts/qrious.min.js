/*! For license information please see qrious.min.js.LICENSE.txt */ ! function(t, e) {
	...
	function t(t, i) {
		var s;
		return "function" == typeof Object.create ? s = Object.create(t) : (n.prototype = t, s = new n, n.prototype = null), i && e(!0, s, i), s
	}

	function e(t, e, i) {
		for (var n, o, a = 0, h = (i = r.call(arguments, 2)).length; a < h; a++)
			for (n in o = i[a]) t && !s.call(o, n) || (e[n] = o[n])
	}
	...
	var n = function() {},
		...
		o = function(i, n, s, r) {
			var o = this;
			return "string" != typeof i && (r = s, s = n, n = i, i = null), "function" != typeof n && (r = s, s = n, n = function() {
				return o.apply(this, arguments)
			}), e(!1, n, o, r), n.prototype = t(o.prototype, s), n.prototype.constructor = n, n.class_ = i || o.class_, n.super_ = o, n
		};
	i.class_ = "Nevis", i.super_ = Object, i.extend = o;
	var a = i,
		h = a.extend((function(t, e, i) {
		...
		d = a.extend((function(t) {
			var e, i, n, s, r, o = t.value.length;
			for (this._badness = [], this._level = u.LEVELS[t.level], this._polynomial = [], this._value = t.value, this._version = 0, this._stringBuffer = []; this._version < 40 && (this._version++, n = 4 * (this._level - 1) + 16 * (this._version - 1), s = u.BLOCKS[n++], r = u.BLOCKS[n++], e = u.BLOCKS[n++], i = u.BLOCKS[n], !(o <= (n = e * (s + r) + r - 3 + (this._version <= 9)))););
			this._dataBlock = e, this._eccBlock = i, this._neccBlock1 = s, this._neccBlock2 = r;
			var a = this.width = 17 + 4 * this._version;
			this.buffer = d._createArray(a * a), this._ecc = d._createArray(e + (e + i) * (s + r) + r), this._mask = d._createArray((a * (a + 1) + 1) / 2), this._insertFinders(), this._insertAlignments(), this.buffer[8 + a * (a - 8)] = 1, this._insertTimingGap(), this._reverseMask(), this._insertTimingRowAndColumn(), this._insertVersion(), this._syncMask(), this._convertBitStream(o), this._calculatePolynomial(), this._appendEccToData(), this._interleaveBlocks(), this._pack(), this._finish()
		}), {
			...
			_appendData: function(t, e, i, n) {
				...
				for (r = 0; r < e; r++) {
					if (255 !== (s = l.LOG[h[t + r] ^ h[i]]))
						for (o = 1; o < n; o++) h[i + o - 1] = h[i + o] ^ l.EXPONENT[d._modN(s + a[n - o])];
					else
						for (o = i; o < i + n; o++) h[o] = h[o + 1];
					h[i + n - 1] = 255 === s ? 0 : l.EXPONENT[d._modN(s + a[0])]
				}
			},
			...
			_calculatePolynomial: function() {
				var t, e, i = this._eccBlock,
					n = this._polynomial;
				for (n[0] = 1, t = 0; t < i; t++) {
					for (n[t + 1] = 1, e = t; e > 0; e--) n[e] = n[e] ? n[e - 1] ^ l.EXPONENT[d._modN(l.LOG[n[e]] + t)] : n[e - 1];
					n[0] = l.EXPONENT[d._modN(l.LOG[n[0]] + t)]
				}
				for (t = 0; t <= i; t++) n[t] = l.LOG[n[t]]
			},
			_checkBadness: function() {
				var t, e, i, n, s, r = 0,
					...
					h = this.width;
				for (s = 0; s < h - 1; s++)
					for (n = 0; n < h - 1; n++)(a[n + h * s] && a[n + 1 + h * s] && a[n + h * (s + 1)] && a[n + 1 + h * (s + 1)] || !(a[n + h * s] || a[n + 1 + h * s] || a[n + h * (s + 1)] || a[n + 1 + h * (s + 1)])) && (r += d.N2);
				var f = 0;
				for (s = 0; s < h; s++) {
			...
			_getBadness: function(t) {
				var e, i = 0,
					n = this._badness;
				for (e = 0; e <= t; e++) n[e] >= 5 && (i += d.N1 + n[e] - 5);
				for (e = 3; e < t - 1; e += 2) n[e - 2] === n[e + 2] && n[e + 2] === n[e - 1] && n[e - 1] === n[e + 1] && 3 * n[e - 1] === n[e] && (0 === n[e - 3] || e + 3 > t || 3 * n[e - 3] >= 4 * n[e] || 3 * n[e + 3] >= 4 * n[e]) && (i += d.N3);
				return i
			},
			_finish: function() {
				...
				i !== e && this._applyMask(i), n = u.FINAL_FORMAT[i + (this._level - 1 << 3)];
				var s = this.buffer,
					r = this.width;
			...
			_insertVersion: function() {
				var t, e, i, n, s = this.buffer,
					...
					o = this.width;
				if (r > 6)
					for (t = _.BLOCK[r - 7], e = 17, i = 0; i < 6; i++)
			...
			_getMaskBit: function(t, e) {
				var i;
				return t > e && (i = t, t = e, e = i), i = e, i += e * e, (i >>= 1) + t
			},
			_modN: function(t) {
		...
		k = a.extend((function(t) {
			...
			get: function(t, e) {
				return k._get(this.options[t], e)
			},
			getAll: function(t) {
				var e, i = this.options,
					n = {};
				for (e in i) g.hasOwn(i, e) && (n[e] = k._get(i[e], t));
				return n
			},
			init: function(t, e, i) {
				var n, s;
				for (n in "function" != typeof i && (i = g.noop), this.options) g.hasOwn(this.options, n) && (s = this.options[n], k._set(s, s.defaultValue, e), k._createAccessor(s, e, i));
				this._setAll(t, e, !0)
			},
			set: function(t, e, i) {
			...
			_setAll: function(t, e, i) {
				if (!t) return !1;
				var n, s = !1;
				for (n in t) g.hasOwn(t, n) && this._set(n, t[n], e, i) && (s = !0);
				return s
			}
		}, {
		...
		b = new w([new m("background", !0, "white"), new m("backgroundAlpha", !0, 1, g.abs), new m("element"), new m("foreground", !0, "black"), new m("foregroundAlpha", !0, 1, g.abs), new m("level", !0, "L", g.toUpperCase), new m("mime", !0, "image/png"), new m("padding", !0, null, g.abs), new m("size", !0, 100, g.abs), new m("value", !0, "")]),
		B = new M,
		y = a.extend((function(t) {
			...
			this._canvasRenderer = new f(this, n, !0), this._imageRenderer = new p(this, s, s === e), this.update()
		}), {
			get: function() {
